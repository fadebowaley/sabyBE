...
module.exports.PaymentSettlement = require('./paymentSettlement.model');
...
module.exports.SubscriptionCatalog = require('./subscriptionCatalog.model');
...
module.exports.WorkspaceInvitation = require('./workspaceInvitation.model');
module.exports.TenantKnowledgeArtifact = require('./tenantKnowledgeArtifact.model');
module.exports.ExecutiveIntelligenceAuditEvent = require('./executiveIntelligenceAuditEvent.model');
module.exports.ExecutiveIntelligenceReportExport = require('./executiveIntelligenceReportExport.model');
module.exports.ExecutiveSandboxExecution = require('./executiveSandboxExecution.model');
module.exports.ExecutiveSemanticMemory = require('./executiveSemanticMemory.model');

module.exports.CmsPage = require('./cmsPage.model');
