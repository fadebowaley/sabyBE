...
const PROFILE_UPDATE_FIELDS = [
  ...
  },
  {
    key: 'title',
    label: 'Title',
    description: 'Preferred title (Mr, Mrs, Dr, etc.)',
    path: ['profile', 'title'],
    type: 'text',
    maxLength: 20,
  },
  {
    key: 'otherName',
    label: 'Other Name',
    description: 'Middle or additional names',
    path: ['profile', 'otherName'],
    type: 'text',
    maxLength: 60,
    aliases: ['middle name', 'middlename', 'other'],
  },
  {
    key: 'gender',
    label: 'Gender',
  ...
  },
  {
    ...
    path: ['profile', 'highestQualification'],
    type: 'text',
    maxLength: 120,
  ...
  },
  {
    ...
    description: 'Employment category / sector',
    path: ['profile', 'employmentCategory'],
    type: 'text',
    maxLength: 120,
    aliases: ['employment', 'employment category'],
  },
  {
    key: 'occupation',
    label: 'Occupation',
  ...
  },
  {
    key: 'employeeId',
    label: 'Employee ID',
    description: 'Internal employee or staff ID',
  ...
  },
  {
    ...
    aliases: ['marital', 'marriage status'],
  },
  {
    key: 'spouseName',
    label: 'Spouse Name',
    description: 'Full name of spouse',
    path: ['profile', 'spouse', 'name'],
    type: 'text',
    maxLength: 120,
    aliases: ['spouse'],
  },
  {
    ...
    label: 'Spouse Phone',
    description: 'Phone number of spouse',
    path: ['profile', 'spouse', 'phoneNumber'],
    type: 'phone',
    aliases: ['spouse phone', 'spouse phone number'],
  },
  {
    key: 'spouseDateOfBirth',
    label: 'Spouse DOB',
    description: 'Spouse date of birth (YYYY-MM-DD)',
    path: ['profile', 'spouse', 'dateOfBirth'],
    type: 'date',
    aliases: ['spouse dob', 'spouse birthdate'],
  },
  {
    key: 'nextOfKinName',
    label: 'Next of Kin Name',
    description: 'Full name of next of kin',
    path: ['profile', 'nextOfKin', 'name'],
    type: 'text',
    maxLength: 120,
    aliases: ['nok name', 'next of kin'],
  },
  {
    key: 'nextOfKinPhoneNumber',
    label: 'Next of Kin Phone',
    description: 'Phone number of next of kin',
    path: ['profile', 'nextOfKin', 'phoneNumber'],
    type: 'phone',
    aliases: ['nok phone'],
  },
  {
    ...
    path: ['profile', 'nextOfKin', 'relationship'],
    type: 'text',
    maxLength: 60,
    aliases: ['nok relationship'],
  },
  {
    key: 'stateOfOrigin',
    label: 'State of Origin',
    description: 'Home state',
    path: ['profile', 'stateOfOrigin'],
    type: 'text',
    maxLength: 120,
    aliases: ['origin state'],
  },
  {
    key: 'lgaOfOrigin',
    label: 'LGA of Origin',
    description: 'Local government area of origin',
    path: ['profile', 'lgaOfOrigin'],
    type: 'text',
    maxLength: 120,
    aliases: ['origin lga'],
  },
  ...
  },
  {
    ...
    path: ['profile', 'residentialAddress'],
    type: 'text',
    maxLength: 240,
  ...
  },
  {
    ...
    description: 'Current local government area',
    path: ['profile', 'lgaOfResidence'],
    type: 'text',
    maxLength: 120,
    aliases: ['residence lga'],
  },
];
