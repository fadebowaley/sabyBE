...
router
  .route('/bulk-import')
  .post(auth('create:node'), validate(nodeValidation.bulkImportNodes), nodeController.bulkImportNodes);
...
router
  ...
  .patch(auth('update:node'), validate(nodeValidation.assignUsersToNode), nodeController.assignUsersToNode);
