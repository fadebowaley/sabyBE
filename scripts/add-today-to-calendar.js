/**
 * Add Today's Date to Calendar for Testing
 *
 * This script adds the current date to the November 2025 calendar
 * for proj_y2sZX9llL5D3 to enable immediate compliance testing.
 *
 * Usage: node scripts/add-today-to-calendar.js
 */
...
async function addTodayToCalendar() {
  ...
  console.log("📅 Adding today's date to calendar...");
